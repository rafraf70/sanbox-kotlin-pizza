...
import rafraf70.sandbox.pizza.PizzaApp
...
object Messages {
    ...
    private val DEFAULT_RESOURCE_BUNDLE_LOCATION : String = PizzaApp::class.java.packageName  + ".messages"

    fun resolve(key : String, vararg values : Any?) = resolve(Locale.getDefault(), key, *values)

    private fun resolve(locale : Locale, key : String, vararg values : Any?) =  resolve(
            DEFAULT_RESOURCE_BUNDLE_LOCATION,
            locale,
            key,
            *values
        )
